...
export class InvoiceService {
  ...
  protected convertDateFromClient(invoice: IInvoice): IInvoice {
    const copy: IInvoice = Object.assign({}, invoice, {
      ...
      invoicePaidDate:
        invoice.invoicePaidDate != null && invoice.invoicePaidDate.isValid() ? invoice.invoicePaidDate.format(DATE_FORMAT) : null,
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.invoicePaidDate = res.body.invoicePaidDate != null ? moment(res.body.invoicePaidDate) : null;
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((invoice: IInvoice) => {
        ...
        invoice.invoicePaidDate = invoice.invoicePaidDate != null ? moment(invoice.invoicePaidDate) : null;
