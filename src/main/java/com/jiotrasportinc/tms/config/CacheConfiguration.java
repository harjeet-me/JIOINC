package com.jiotrasportinc.tms.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.jiotrasportinc.tms.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.jiotrasportinc.tms.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.jiotrasportinc.tms.domain.User.class.getName());
            createCache(cm, com.jiotrasportinc.tms.domain.Authority.class.getName());
