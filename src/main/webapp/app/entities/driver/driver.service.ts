...
export class DriverService {
  ...
  protected convertDateFromClient(driver: IDriver): IDriver {
    const copy: IDriver = Object.assign({}, driver, {
      ...
      companyJoinedOn:
        driver.companyJoinedOn != null && driver.companyJoinedOn.isValid() ? driver.companyJoinedOn.format(DATE_FORMAT) : null,
      companyLeftOn: driver.companyLeftOn != null && driver.companyLeftOn.isValid() ? driver.companyLeftOn.format(DATE_FORMAT) : null
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.companyJoinedOn = res.body.companyJoinedOn != null ? moment(res.body.companyJoinedOn) : null;
      res.body.companyLeftOn = res.body.companyLeftOn != null ? moment(res.body.companyLeftOn) : null;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((driver: IDriver) => {
        ...
        driver.companyJoinedOn = driver.companyJoinedOn != null ? moment(driver.companyJoinedOn) : null;
        driver.companyLeftOn = driver.companyLeftOn != null ? moment(driver.companyLeftOn) : null;
      });
    }
    return res;
  }
