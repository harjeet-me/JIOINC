...
/**
 * REST controller for managing {@link com.jiotrasportinc.tms.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    public List<Customer> getAllCustomers(@RequestParam(required = false) String filter) {
        if ("contact-is-null".equals(filter)) {
            log.debug("REST request to get all Customers where contact is null");
            return customerService.findAllWhereContactIsNull();
        }
