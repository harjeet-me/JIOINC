...
import com.jiotrasportinc.tms.repository.OwnerOperatorRepository;
import com.jiotrasportinc.tms.repository.search.OwnerOperatorSearchRepository;
import com.jiotrasportinc.tms.service.OwnerOperatorService;
...
public class OwnerOperatorResourceIT {
     ...
     *
     * @see com.jiotrasportinc.tms.repository.search.OwnerOperatorSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createOwnerOperator() throws Exception {
        ...
        assertThat(testOwnerOperator.getRemarks()).isEqualTo(DEFAULT_REMARKS);
    ...
    public void updateOwnerOperator() throws Exception {
        ...
        assertThat(testOwnerOperator.getRemarks()).isEqualTo(UPDATED_REMARKS);
